        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper pl-1">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><u class="ml-25">Elevations : {{ ucwords($home_title) }}</u>
                    </li>
                </ol>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6">
            <div class="card" id="card{{$elevation->id}}">
                ...
                <div class="card-footer border-top-blue-grey border-top-lighten-5 text-muted">
                    <span class="float-left">Updated On: {{date('d-m-Y',strtotime($elevation->updated_at))}}</span>
                    <span class="float-right">
                        ...
                        <a href="{{route('floorplanlist',['elevation_id' => base64_encode($elevation->id)])}}" data-toggle="tooltip" title="View Design Types" class="text-dark mr-25"> <i class="ft-eye"></i> </a>
                        <!-- <a href="{{route('home-design-types',['elevation_id' => base64_encode($elevation->id)])}}" data-toggle="tooltip" title="View Settings" class="text-dark mr-25"> <i class="ft-settings"></i> </a> -->
                        <!-- <a href="javascript:;" onclick="HomePlanModal(true, '{{$elevation->title}}', '{{$elevation->status_id}}', '{{$elevation->base_image}}',{{$elevation->id}})" data-toggle="tooltip" title="Edit Homeplan" class="text-dark mr-25 edit-button"> <i class="ft-edit"></i> </a>
                    ...
                    card = `<div class="col-xl-3 col-lg-4 col-sm-6">
                                <div class="card" id="card${response.id}">
                                    ...
                                    <div class="card-footer border-top-blue-grey border-top-lighten-5 text-muted">
                                        ...
                                        <span class="float-right">
                                            <a href="/admin/exterior/elevations/${btoa(response.id)}" data-toggle="tooltip" title="View Design Types" class="text-dark mr-25"> <i class="ft-eye"></i> </a>
