...
<div class="content-header d-flex flex-wrap justify-content-between align-items-center bg-white" style="padding: 0.8rem 2rem 0.4rem;">
        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{route('elevations', base64_encode($home_id))}}">{{ ucwords($home_title) }}</a>
                    </li>
                    <li class="breadcrumb-item text-capitalize">
                        <a href="{{route('home-design-types', ['elevation_id' => $elevation_id])}}" class="text-capitalize">{{$elevation_title}}</a>
                    </li>
                    <li class="breadcrumb-item">
                        <u class="text-capitalize">{{$design_type_title}}</u>
                    </li>
                </ol>
            </div>
        </div>
    ...
    <div class="content-header-right">
        <a href="{{route('home-design-types', ['elevation_id' => $elevation_id])}}" class="btn btn-secondary square btn-min-width waves-effect waves-light box-shadow-2 px-2 standard-button"> 
            ...
            <div class="card" id="card{{$design->id}}">
                ...
                <div class="card-content">
                    <div class="d-flex justify-content-center" style="position:relative;">
                        <img class="img-fluid" src="{{asset('media/uploads/exterior/'.$design_type_slug.'/'.$design->thumbnail)}}" style="height:100px">
        ...
        <div class="modal-content">
            ...
            <form id="designForm">
                ...
                <div class="modal-footer">
                    <button type="button" id="submitButton" onclick="submitForm(true)" data-type-id="{{$design_type_id}}" data-group-id="{{$elevation_id}}" class="btn btn-dark text-white m-0">
...
@push('scripts')
<script>
    const path = '{{asset("media/uploads/exterior/".$design_type_slug)}}';
    const date = new Date();
