            ...
            <div class="card" id="card{{$design->id}}">
                ...
                <div class="card-content">
                    <div class="d-flex justify-content-center" style="position:relative;">
                        <img class="img-fluid" src="{{asset('media/uploads/'.$design_type_path.'/'.$design->thumbnail)}}" style="height:100px">
            ...
            <form id="designForm">
                <div class="modal-body">
                    ...
                    <div class="form-group d-flex flex-wrap justify-content-start">
                        ...
                        <div class="mr-2">
                            <label for="image" class="text-uppercase ml-0">base image</label>
                            <figure class="position-relative w-150 mb-0">
                                <img src="{{asset('media/placeholder.jpg')}}" class="img-thumbnail">
...
<script>
    ...
    const path = '{{asset("media/uploads/".$design_type_path)}}';
    const date = new Date();
