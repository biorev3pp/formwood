        ...
        <div class="modal-content">
            <form id="recordForm">
                <div class="modal-header border-bottom">
                    <h3 class="modal-title"> Add New Quality</h3>
...
<script>
    ...
    function addCategory(...values){
        ...
        if(values[0] == true){
            modal.find('.modal-title').text('Edit Quality')
            ...
            modal.find('.modal-title').text('Add New Quality')
    ...
    function submitForm(editable){
        ...
        if(editable == true){
            ...
            $.ajax({
                type: 'POST',
                url: siteURL+'/api/update/qualities/'+HomePlanId,
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                data: formData,
                processData: false,
                contentType: false,
                success: function(response){
                    toastr.info('Quality has been updated successfully.');
                    let card = null;
            ...
            $.ajax({
                type: 'POST',
                url: siteURL+'/api/create/qualities',
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                data: formData,
                processData: false,
                contentType: false,
                success: function(response){
                    toastr.info('Quality has been added successfully.');
                    let card = null;
    ...
    $(document).ready(function(){
        ...
        $('#bulk_action_btn').on('click', function(){
            ...
            $.ajax({
                type: 'POST',
                url: siteURL+'/api/bulk/qualities',
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                data: formData,
                processData: false,
                contentType: false,
