        ...
        <div class="modal-content">
            <form id="recordForm">
                <div class="modal-header border-bottom">
                    <h3 class="modal-title"> Add New Matching</h3>
...
<script>
    ...
    function addCategory(...values){
        ...
        if(values[0] == true){
            modal.find('.modal-title').text('Edit Matching')
            ...
            modal.find('.modal-title').text('Add New Matching')
    ...
    function submitForm(editable){
        ...
        if(editable == true){
            ...
            $.ajax({
                type: 'POST',
                url: siteURL+'/api/update/matchings/'+HomePlanId,
            ...
            $.ajax({
                type: 'POST',
                url: siteURL+'/api/create/matchings',
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                data: formData,
                processData: false,
                contentType: false,
    ...
    $(document).ready(function(){
        ...
        $('#bulk_action_btn').on('click', function(){
            ...
            $.ajax({
                type: 'POST',
                url: siteURL+'/api/bulk/matchings',
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                data: formData,
                processData: false,
                contentType: false,
